...
timesteps = 20
# decoder
decoder_h = LSTM(intermediate_dim, return_state = False, return_sequences =True, name='dec_lstm_h')
decoder_mean = LSTM(input_dim, return_state = False, return_sequences= True, name='dec_lstm_mean')
